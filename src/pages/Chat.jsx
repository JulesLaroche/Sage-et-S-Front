                            ...
                            <div className="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen">
                                ...
                                <div className="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
                                    <div className="relative flex">
                                        ...
                                        {/* </span> */}
                                        <input type="text" placeholder="Ecrire votre message!" className="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3" />
