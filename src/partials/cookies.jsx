...
function Cookies() {
    return (
        ...
        <div x-data="{ open: false }" x-init="() => setTimeout(() => open = true, 500)" className="py-6 flex flex-col justify-center sm:py-12">
            ...
            <div x-show="open"
                ...
                <div className="flex gap-4 items-center flex-shrink-0">
                    ...
                    <button className="bg-indigo-500 px-5 py-2 text-white rounded-md hover:bg-indigo-700 focus:outline-none">Allow Coockies</button>
                </div>
            </div >
        </div >
