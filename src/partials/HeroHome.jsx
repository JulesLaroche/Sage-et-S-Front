...
function HeroHome() {
  ...
  return (
    <section className='pb-20'>
      <div className="max-w-6xl mx-auto px-4 py-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-1">
          ...
          <div className="max-w-4xl mx-auto text-center pb-8 md:pb-8">
            ...
            Parce que vous voulez être utiles en rendant service <br /> Parce que vous avez un besoin
            </p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              ...
              <div data-aos="fade-up" data-aos-delay="500">
                <a className="btn text-white bg-gray-700 hover:bg-gray-800 w-full sm:w-auto sm:ml-4" href="/SignUp">
                  Je deviens un apprenti
                </a>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 pb-5 sm:px-6">
        ...
        {/* CTA box */}
        <div className="relative  py-12 px-8 md:py-8 md:px-12" data-aos="fade-up">
